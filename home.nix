  ...
  programs = {
    ...
    git = {
      ...
      settings = {
        ...
        alias = {
          pr = "!f() { git fetch $1 refs/pull/$2/head:pr/$2 && git switch pr/$2; }; f";
          mr = "!f() { git fetch $1 refs/merge-requests/$2/head:mr/$2 && git switch mr/$2; }; f";
        };
        diff.tool = "nvimdiff";
      ...
      hyprland = {
        ...
        settings = {
          ...
          exec-once = [
            ...
            "[workspace special:scratchpad silent] $notes"
            "[workspace special:scratchpad silent] $music"
          ];
          bind = [
            "$mod, ESCAPE, exit,"
            ...
            "$mod, F, fullscreen"
            "$mod, M, togglespecialworkspace, scratchpad"
            "$mod SHIFT, M, movetoworkspace, special:scratchpad"
