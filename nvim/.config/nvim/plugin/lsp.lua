...
wk.add({
    { "<leader>l", group = "Language Server", desc = "", nowait = true, remap = false },
})
...
-- Trouble
wk.add({
    { "<leader>t", group = "Trouble", desc = "", nowait = true, remap = false },
})

vim.keymap.set("n", "<leader>tx", "<cmd>Trouble diagnostics toggle<cr>", { desc = "Diagnostics (Trouble)" })
vim.keymap.set("n", "<leader>tX", "<cmd>Trouble diagnostics toggle filter.buf=1<cr>",
